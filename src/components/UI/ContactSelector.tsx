...
const ContactSelector = ({ selectedContact, onContactChange }: ContactSelectorProps) => {
  ...
  return (
    <div className="px-4 md:px-6 lg:px-8 py-4 bg-white border-b border-gray-200">
        ...
        {isOpen && (
          <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
            {loading ? (
              ...
              <div className="p-3 text-gray-500">No contacts available</div>
            ) : (
